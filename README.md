...
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=bugs)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=code_smells)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=duplicated_lines_density)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=ncloc)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=vulnerabilities)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)

[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=joelguittet_mender-esp32-example&metric=security_rating)](https://sonarcloud.io/dashboard?id=joelguittet_mender-esp32-example)
...
The project is built using ESP-IDF framework. There is no other dependencies. Important note: the project has been tested with ESP-IDF v5.2.x, v5.3.x, v5.4.x, v5.5.x and v6.0.x successfully.
